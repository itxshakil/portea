        ...
        <div className="min-h-screen">
            ...
            <section className="bg-teal-50 py-12 md:py-20">
                <div className="container px-4 md:px-6 mx-auto text-center">
                    <h1 className="text-3xl md:text-4xl font-bold tracking-tight">
                        Privacy Policy
                        <span className="block text-teal-600 mt-2">Your Data & Confidentiality Matters to Us</span>
                    </h1>
            ...
            <section className="py-16 bg-white">
                <div className="container px-4 md:px-6 mx-auto max-w-5xl space-y-12">
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">1. Information We Collect</h2>
                    ...
                    {/* How We Use Data */}
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">2. How We Use Your Information</h2>
                        <ul className="list-disc list-inside text-gray-600 space-y-2">
                    ...
                    {/* Data Sharing */}
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">3. Data Sharing & Disclosure</h2>
                        <p className="text-gray-600 mb-3">
                    ...
                    {/* Data Security */}
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">4. Data Security</h2>
                        <p className="text-gray-600 mb-3">
                    ...
                    {/* User Rights */}
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">5. Your Rights</h2>
                        <p className="text-gray-600 mb-3">
                    ...
                    {/* Policy Changes */}
                    <div>
                        <h2 className="text-2xl font-bold mb-4 text-teal-600">6. Policy Updates</h2>
